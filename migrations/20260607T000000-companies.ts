...
export async function up(db: Kysely<unknown>): Promise<void> {
  await db.schema
    ...
    .addColumn("oib", "text", (col) => col.notNull())
    ...
    .addColumn("legal_text_domestic", "text", (col) => col.notNull().defaultTo(""))
    .addColumn("legal_text_foreign_hr", "text", (col) => col.notNull().defaultTo(""))
    .addColumn("legal_text_foreign_en", "text", (col) => col.notNull().defaultTo(""))
    .addColumn("email_from_address", "text", (col) => col.notNull())
    .addColumn("email_from_name", "text", (col) => col.notNull())
    .addColumn("email_subject_template", "text", (col) => col.notNull().defaultTo(""))
    .addColumn("email_body_template", "text", (col) => col.notNull().defaultTo(""))
  ...
  await db.schema
    ...
    .addColumn("name_en", "text", (col) => col.notNull().defaultTo(""))
