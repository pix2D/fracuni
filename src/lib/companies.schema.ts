...
export const CompanyFieldsSchema = z.object({
  ...
  legalTextServiceDomesticHr: optionalText,
  legalTextServiceEuB2cHr: optionalText,
  legalTextServiceEuB2cEn: optionalText,
  legalTextServiceEuB2bReverseChargeHr: optionalText,
  legalTextServiceEuB2bReverseChargeEn: optionalText,
  legalTextServiceEuB2bWithoutVatIdHr: optionalText,
  legalTextServiceEuB2bWithoutVatIdEn: optionalText,
  legalTextServiceNonEuB2cHr: optionalText,
  legalTextServiceNonEuB2cEn: optionalText,
  legalTextServiceNonEuB2bHr: optionalText,
  legalTextServiceNonEuB2bEn: optionalText,
